function perso2sofa(subjectID, CIPIC, target_path)
% personal adaptation of the cipic2sofa function
...
Obj.GLOBAL_DatabaseName = 'HRIR_sphericalHead';
Obj.GLOBAL_ApplicationName = 'Demo of the SOFA API';
Obj.GLOBAL_ApplicationVersion = SOFAgetVersion('API');

%% save SOFA file
SOFAfn=fullfile(target_path, ['CIPIC_' 'subject_' sprintf('%03d',subjectID) '_' CIPICfile '.sofa']);
disp(['Saving:  ' SOFAfn])
